...
class SleepNightAdapter(private val clickListener: SleepNightClickListener) :
    ...
    class ViewHolder private constructor(private val binding: GridItemSleepNightBinding) :
